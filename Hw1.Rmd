...
knitr::kable(head(eco3), format = 'pandoc', digits=1, padding = 2, caption = 'Mean conductivity, pH, total nitrogen concentration, turbidity, and % of agrigulture in watershed')
```
...
```{r p, fig.cap="Box plot of conductivity for each ecoregion (ECO3)"}
dta <-read.csv("wemap.csv")
require(ggplot2)
