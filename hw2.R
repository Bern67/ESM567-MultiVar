...
qqline(env$TNsed)
qqnorm(env$AFDMsed, fg = gray(0.7), main="AFDMsed") # Grey border- Potential normality deviation
qqline(env$AFDMsed)
...
qqline(env$NO3.N)
qqnorm(env$FILT.TN, fg = gray(0.7), main="FILT.TN")
qqline(env$FILT.TN)
...
qqline(env$SIO2)
qqnorm(env$UNFILT.TP, fg = gray(0.7), main="UNFILT.TP")
